    ...
    <div class="profile">
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('profile') }}" class="bg-gray-600 text-white text-sm uppercase py-2 px-4 flex items-center rounded shadow hover:bg-gray-700 transition duration-200">
        ...
        <div class="mt-8 bg-white rounded-lg shadow-lg">
            <form action="{{ route('profile.update') }}" method="POST" class="w-full max-w-2xl mx-auto px-6 py-8 flex flex-wrap justify-between" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="w-full sm:w-auto order-last sm:order-first">
                    ...
                    <div class="md:flex md:items-center">
                        ...
                        <div class="md:w-2/3">
                            <button class="w-full shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded transition duration-200" type="submit">
                                Submit Changes
                            </button>
                        </div>
                    </div>
                ...
                <div class="order-first sm:order-last mb-4">
                    <div class="flex justify-center">
                        <img class="w-32 h-32 sm:w-32 sm:h-32 rounded-full border-4 border-gray-200 shadow-lg" src="{{ asset('images/profile/' . auth()->user()->profile_picture) }}" alt="avatar">
                    </div>
                </div>
            </form>
        </div>
